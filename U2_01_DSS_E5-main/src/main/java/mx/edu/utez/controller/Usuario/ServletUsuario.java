            ...
            if(dataSession[2].equals("admin")){
                switch (action) {
                    ...
                    case "/agregar-usuario":
                        ...
                        UsuarioBean nuevoUsuario = gson.fromJson(requestBody, UsuarioBean.class);
                        ...
                        String respuesta = resultado ? "Usuario registrado con éxito" : "Error al registrar usuario";
