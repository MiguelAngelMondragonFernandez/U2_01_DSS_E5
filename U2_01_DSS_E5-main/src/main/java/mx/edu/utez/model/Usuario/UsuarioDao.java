...
public class UsuarioDao {
    ...
    public static boolean registrarUsuario(UsuarioBean usuario) {
        String sqlQuery = "INSERT INTO usuarios (nombre, aPaterno, aMaterno, correo, telefono, edad, rol) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            int res = pstm.executeUpdate();
            boolean resBitacora = addBitacora(usuario.getId(), "POST");
            registrado = res > 0 && resBitacora;
        } catch (SQLException e) {
